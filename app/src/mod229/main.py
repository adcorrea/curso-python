...
# ABCs são usadas como contratos para a definição de novas classes. Elas
# podem forçar outras classes a criarem métodos concretos. Também podem ter métodos
# concretos por elas mesmas.

# @abstractmethods são métodos que não têm corpo. As regras para classes
# abstratas com métodos abstratos é que elas NÃO PODEM ser instanciadas
# diretamente.
